...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => getIt<MoviesDetailsBloc>()
                  ...
                  background: FadeIn(
                    ...
                    child: ShaderMask(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: ApiConstantsMovies.imageUrl(state.moviesDetails!.backdropPath),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                state.moviesDetails!.releaseData.split('-')[0],
        ...
        delegate: SliverChildBuilderDelegate(
            ...
            return FadeInUp(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl:
                  ApiConstantsMovies.imageUrl(recommendation.backDropPath!),
